...
export const Search = ({setSearchSection}) => {
  ...
  const handleSearch= (event) => {
    ...
    // When the search page is opened, the search input/component should be hidden/disabled.
    // So we set `setSearchSection(false)` to hide it.
    // Then we navigate to the products page with the search query in the URL.
